...
/***/ (function(module, exports, __webpack_require__) {
	...
	new _Animation2.default().play(function (d) {
	  return console.log(d);
	}); /**
	     * Created by khalilove on 2017-04-26.
	     */
	    ...
	    (0, _createClass3.default)(_class, [{
	        ...
	        value: function play(progress) {
	            ...
	            return new _promise2.default(function (resolve, reject) {
	                ...
	                options = (0, _assign2.default)({}, _this.options, options, { progress: progress });
	                ...
	                var start = new Date(),
	                    ...
	                    try {
	                        ...
	                        (_options$progress = options.progress).call.apply(_options$progress, [options.scope, delta].concat((0, _toConsumableArray3.default)(options.args)));
